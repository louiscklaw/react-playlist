  ...
  return (
    <>
      <div style={{ display: 'flex', flexFlow: 'column' }}>
        ...
        <button onClick={() => sendMachine1('STATE_ONE')}>STATE_ONE</button>
        <button onClick={() => sendMachine1('STATE_TWO')}>STATE_TWO</button>
        <button onClick={() => sendMachine1('STATE_THREE')}>STATE_THREE</button>
      </div>
    </>
  );
}
