...
describe('Cleans up screenshot directories', () => {
  it('Deletes comparison/ and screenshots/', () => {
    cy.exec('rm cypress/screenshots/screencaps.spec.js/*', {
      failOnNonZeroExit: false,
    });
    cy.exec('rm cypress-visual-screenshots/comparison/*', {
      failOnNonZeroExit: false,
    });
    cy.exec('rm cypress-visual-screenshots/diff/*', {
      failOnNonZeroExit: false,
    });
  });
});
...
describe('Snapshots of public pages on 13" MacBook', () => {
  context('13" MacBook', () => {
    ...
    it('Acknowledgements page snapshot comparison', () => {
      cy.visit('http://localhost:3000/acknowledgements');
...
//       cy.student_login().then(() => {
//         cy.wait(500);
//         cy.get('.performance-report-tab').click();
//         cy.compareSnapshot(
//           'student-profile-performance-report-tab-macbook13',
//           0.1
//         );
//       });
//     });
...
//       cy.student_login().then(() => {
//         cy.wait(500);
//         cy.get('.difficulty-select').select('Intermediate-Mid');
//         cy.compareSnapshot(
//           'student-profile-difficulty-dropdown-macbook13',
//           0.1
//         );
//       });
//     });
...
describe('Snapshots of public pages on IPhone X', () => {
  context('IPhone X', () => {
    ...
    it('Home page snapshot comparison', () => {
      cy.visit('https://www.hko.gov.hk/en/gts/time/clock_e.html');
