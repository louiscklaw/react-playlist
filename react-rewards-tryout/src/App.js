...
export default class App extends Component {
  state = { ...defaults.confetti, rewardPunish: "reward" };

  fakeRequest = () => {
    const { rewardPunish } = this.state;
    this.setState({ fakingRequest: true });
    setTimeout(() => {
          ...
          <Row style={rowStyle}>
            <Col style={colStyle} span={24}>
              <Radio.Group
                ...
                disabled={disabled}
              >
                <Radio.Button value="confetti">
                  Confetti{" "}
                  <span role="img" aria-label="confetti switch">
                    🎉
                  </span>
                </Radio.Button>
                <Radio.Button value="emoji">
                  Emoji{" "}
                  <span role="img" aria-label="emoji switch">
                    👍
                  </span>
                </Radio.Button>
                <Radio.Button value="memphis">
                  Memphis{" "}
                  <span role="img" aria-label="memphis switch">
                    🔸
                  </span>
                </Radio.Button>
              </Radio.Group>
