...
import { Box, Text, Link, VStack, Code, Grid, Stack, HStack, IconButton } from '@chakra-ui/react'
...
export function ButtonTryout() {
  return (
    <div>
      ...
      <div>
        {' '}
        // The size prop affects the height of the button // It can still be overridden by passing a
        custom height
